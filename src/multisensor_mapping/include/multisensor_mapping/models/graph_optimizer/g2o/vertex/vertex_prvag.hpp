#ifndef MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_VERTEX_VERTEX_PRVAG_HPP_
#define MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_VERTEX_VERTEX_PRVAG_HPP_
...
struct PRVAG {
    // indices to help construct matrices
    ...
    void write(double *data) const {
        // store orientation in so3 instead of SO3
...
public:
    ...
    virtual void oplusImpl(const double *update) override {
        ...
        // update orientation R_world_current = R_world_last * R_last_current
...
#endif // MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_VERTEX_VERTEX_PRVAG_HPP_
