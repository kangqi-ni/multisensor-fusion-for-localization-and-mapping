#ifndef MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_IMU_PRE_INTEGRATION_HPP_
#define MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_IMU_PRE_INTEGRATION_HPP_
...
public:
	...
	EdgePRVAGIMUPreIntegration(): g2o::BaseBinaryEdge<15, Vector15d, g2o::VertexPRVAG, g2o::VertexPRVAG>() {}
	...
	virtual void computeError() override {
		...
		// update pre-integration measurement affected by bias change
		if (v0->isUpdated()) {
	...
	void updateMeasurement(
		...
		// update velocity measurement with delta bias
...
#endif // MULTISENSOR_MAPPING_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_IMU_PRE_INTEGRATION_HPP_
