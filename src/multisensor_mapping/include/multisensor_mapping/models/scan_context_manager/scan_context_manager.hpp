#ifndef MULTISENSOR_MAPPING_MODELS_SCAN_CONTEXT_MANAGER_HPP_
#define MULTISENSOR_MAPPING_MODELS_SCAN_CONTEXT_MANAGER_HPP_
...
#include "multisensor_mapping/models/scan_context_manager/kdtree_vector_of_vectors_adaptor.hpp"
