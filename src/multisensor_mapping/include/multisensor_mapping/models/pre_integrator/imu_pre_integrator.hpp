#ifndef MULTISENSOR_MAPPING_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_
#define MULTISENSOR_MAPPING_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_

#include "multisensor_mapping/models/pre_integrator/pre_integrator.hpp"
...
private:
    ...
    // 2. prior state covariance, process & measurement noise
    struct {
        struct {
            double ACCEL;
            double GYRO;
...
#endif // MULTISENSOR_MAPPING_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_