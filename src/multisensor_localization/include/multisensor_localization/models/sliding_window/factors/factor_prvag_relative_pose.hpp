#ifndef MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_FACTOR_PRVAG_RELATIVE_POSE_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_FACTOR_PRVAG_RELATIVE_POSE_HPP_
...
public:
  ...
  virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const {
    ...
    if (jacobians) {
      ...
      const Eigen::Matrix3d J_r_inv = JacobianRInv(residuals_eigen.block<3,1>(INDEX_R, 0));
...
#endif // MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_FACTOR_PRVAG_RELATIVE_POSE_HPP_
