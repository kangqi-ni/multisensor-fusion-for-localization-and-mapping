#ifndef MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_UTILS_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_UTILS_HPP_
...
#endif // MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_UTILS_HPP_