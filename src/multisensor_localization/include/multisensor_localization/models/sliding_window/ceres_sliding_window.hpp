#ifndef MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_CERES_SLIDING_WINDOW_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_CERES_SLIDING_WINDOW_HPP_
...
#include "multisensor_localization/models/sliding_window/params/param_prvag.hpp"

#include "multisensor_localization/models/sliding_window/factors/factor_prvag_marginalization.hpp"
#include "multisensor_localization/models/sliding_window/factors/factor_prvag_relative_pose.hpp"
#include "multisensor_localization/models/sliding_window/factors/factor_prvag_map_matching_pose.hpp"
#include "multisensor_localization/models/sliding_window/factors/factor_prvag_imu_pre_integration.hpp"
...
public:
    ...
    struct ResidualMapMatchingPose {
      int param_index; // key frame id

      Eigen::VectorXd m; // measurement
      Eigen::MatrixXd I; // information matrix
    };
...
#endif // MULTISENSOR_LOCALIZATION_MODELS_SLIDING_WINDOW_CERES_SLIDING_WINDOW_HPP_