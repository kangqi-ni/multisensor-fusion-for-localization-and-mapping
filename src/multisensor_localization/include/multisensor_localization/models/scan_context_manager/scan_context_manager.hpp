#ifndef MULTISENSOR_LOCALIZATION_MODELS_SCAN_CONTEXT_MANAGER_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_SCAN_CONTEXT_MANAGER_HPP_
...
#include "multisensor_localization/models/scan_context_manager/kdtree_vector_of_vectors_adaptor.hpp"
