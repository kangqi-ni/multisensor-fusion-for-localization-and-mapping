#ifndef MULTISENSOR_LOCALIZATION_MODELS_PRE_INTEGRATOR_ODO_PRE_INTEGRATOR_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_PRE_INTEGRATOR_ODO_PRE_INTEGRATOR_HPP_

#include "multisensor_localization/models/pre_integrator/pre_integrator.hpp"
...
private:
    ...
    // hyper-params:
    // prior state covariance, process & measurement noise
    struct {
        struct {
            double V;
            double W;
...
#endif // MULTISENSOR_LOCALIZATION_MODELS_PRE_INTEGRATOR_ODO_PRE_INTEGRATOR_HPP_