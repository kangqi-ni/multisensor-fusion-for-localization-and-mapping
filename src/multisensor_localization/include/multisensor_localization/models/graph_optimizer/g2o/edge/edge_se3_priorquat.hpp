#ifndef MULTISENSOR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORQUAT_HPP_
#define MULTISENSOR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORQUAT_HPP_
...
class EdgeSE3PriorQuat : public g2o::BaseUnaryEdge<3, Eigen::Quaterniond, g2o::VertexSE3> {
  public:
	...
	void computeError() override {
		...
		// make sure real part is positive
		if (estimate.w() < 0) {
			estimate.coeffs() = -estimate.coeffs();
		}
		// error is difference between imaginary parts of quaternions
