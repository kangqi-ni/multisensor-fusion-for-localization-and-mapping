#include "multisensor_localization/sensor_data/gnss_data.hpp"

#include "glog/logging.h"
#include <ostream>

double multisensor_localization::GNSSData::origin_latitude = 0.0;
double multisensor_localization::GNSSData::origin_longitude = 0.0;
double multisensor_localization::GNSSData::origin_altitude = 0.0;
bool multisensor_localization::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian multisensor_localization::GNSSData::geo_converter;

namespace multisensor_localization {
void GNSSData::InitOriginPosition() {
    // Set GNSS origin of filtered map recorded during mapping 
