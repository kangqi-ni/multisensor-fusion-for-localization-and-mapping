...
#include "multisensor_localization/models/graph_optimizer/g2o/g2o_graph_optimizer.hpp"
#include "multisensor_localization/tools/tic_toc.hpp"
...
void G2oGraphOptimizer::AddPRVAGOdoPreIntegrationEdge(
    ...
    // initialize
    g2o::EdgePRVAGOdoPreIntegration *edge(
        new g2o::EdgePRVAGOdoPreIntegration()
    );
