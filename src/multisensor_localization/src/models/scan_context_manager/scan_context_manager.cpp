...
#include "multisensor_localization/models/scan_context_manager/ring_keys.pb.hpp"
#include "multisensor_localization/models/scan_context_manager/key_frames.pb.hpp"
